...
const COMMANDS: Record<string, () => OutputLine[]> = {
  ...
  whoami: () => [
    ...
    { text: "│  AI/ML Engineer · MSCS @ Northeastern", type: "output" },
    { text: "│", type: "output" },
    { text: "│  Currently an MSCS student (May 2026) and", type: "output" },
    { text: "│  AI Software Engineer at DASH (Northeastern).", type: "output" },
    { text: "│", type: "output" },
    { text: "│  I ship production agentic systems and built", type: "output" },
    { text: "│  multi-agent grading + voice coaching platforms", type: "output" },
    { text: "│  serving 1000+ students at Northeastern.", type: "output" },
    { text: "│", type: "output" },
    { text: "│  Stack: Python, TypeScript, WebSockets,", type: "output" },
    { text: "│  RabbitMQ, Redis, Docker, and GitHub Actions.", type: "output" },
    { text: "│", type: "output" },
    { text: "│  Fun fact: astronomy nerd; contributed to", type: "output" },
    { text: "│  NASA Pan-STARRS near-Earth observations and", type: "output" },
    { text: "│  designed and simulated a rocket.", type: "output" },
    { text: "│", type: "output" },
